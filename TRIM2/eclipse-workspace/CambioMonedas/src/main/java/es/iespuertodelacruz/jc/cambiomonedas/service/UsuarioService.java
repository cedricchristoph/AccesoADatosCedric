...
import es.iespuertodelacruz.jc.cambiomonedas.repository.UsuarioconrolRepository;

@Service
public class UsuarioService implements GenericServiceInterface<Usuarioconrol,Integer> {
